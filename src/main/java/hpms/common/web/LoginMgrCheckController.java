...
public class LoginMgrCheckController
{
    ...
    public ModelAndView System_Developer_Check(ModelMap model, DOBJ idobj, HttpServletRequest request) throws Exception
    {

        ModelAndView mav = new ModelAndView("riaView");
        
    
        DOBJ odobj = LoginMgrCheckService.System_Developer_Check(idobj,request);
    ...
    public ModelAndView wizLoginSession(ModelMap model, DOBJ idobj, HttpServletRequest request) throws Exception
    {
    ...
    public String SessionLogInfo(ModelMap model, DOBJ idobj ,HttpServletRequest request) throws Exception
    {
    ...
    public String MainPage(ModelMap model, DOBJ idobj, HttpServletRequest request)
      throws Exception
    {
  	  HttpSession session = request.getSession(true);
  	  HashMap hmap = null;
  	  ...
  	  if  (( session == null) || session.getAttribute("G") == null || hmap.size() == 0){
    ...
    public String LogoutPage(ModelMap model, DOBJ idobj, HttpServletRequest request)
      throws Exception
    {
