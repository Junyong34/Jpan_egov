...
public class DevArgv
{
   ...
   /*  private String dbconnstr=EgovProperties.getProperty("Globals.Url");
     private String dbdriver=EgovProperties.getProperty("Globals.DriverClassName");
     private String dbuserid=EgovProperties.getProperty("Globals.MATADBID");
     private String dbpwd=EgovProperties.getProperty("Globals.MATADBPW");
    //*/
    
    private String dbconnstr="jdbc:oracle:thin:@133.232.125.190:1521:orcl";
    private String dbdriver = "oracle.jdbc.driver.OracleDriver";
    private String dbuserid = "HPMSCTL";
    private String dbpwd = "HPMSCTL";
    ...
    public void DevLog(String url, String userid, DOBJ dobj)
    {
        ...
        try
        {
            ...
            System.out.println("DEVLOG WRITE;..............(" + url +")" + conn);
            getUrlInfo(conn, url);
    ...
    public void logwrite(String url, String userid, DOBJ dobj)
    {
        Connection conn= getConnection();
        try
        {
        ...
        {
            System.out.println("Devlog Write Fail");
            try
            {
                conn.rollback();
            }
