...
<div id="pop_wrap">
	...
	<div id="pop_container2" class="pop_container2">
        ...
        <div id="pop_content2">
			<input type="file" class="upload" id="uploadInputBox2" name="Filedata">
            <p class="dsc" id="info"><strong>10MB</strong>이하의 이미지 파일만 등록할 수 있습니다22.<br>(JPG, GIF, PNG, BMP)</p>
        </div>
		</form>
    ...
    <div id="pop_container" class="pop_container" style="display:none;">
        ...
        <div id="pop_content2">
            ...
            <p class="dsc" id="info"><strong>10MB</strong>이하의 이미지 파일만 등록할 수 있습니다11.<br>(JPG, GIF, PNG, BMP)</p>
        </div>
		</form>
