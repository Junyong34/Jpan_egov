...
<head>
        ...
        $(document).ready(function(){ 
               ...
               $("#S_ERROR_CODE").val( getParamdata('ERROR_CODE'));
              $("#S_ERROR_MSG").val( getParamdata('ERROR_MSG'));
...
<form id='frm' name='frm' >
    <div id="hiddenvariable" style="display:none">
        ...
        <input type='hidden'  id="InWIzJsonParma" name="InWIzJsonParma"  value="" ></input>
        	<div  class="titleLabel" style=" position: absolute; top:24px; left:29px;  width:435px; height:34px; " id="label1" name="label1"><label style=" line-height:36px; " >    Error Indication     </label>    </div>

        	<div  class="infoLabel" style=" position: absolute; top:78px; left:54px;  width:131px; height:19px; " id="label2" name="label2"><label style=" line-height:21px; " >    Error Code     </label>    </div>

        	<input  class="TextBox-S" style=" position: absolute; top:78px; left:189px;  width:228px; height:17px; " id="S_ERROR_CODE" name="S_ERROR_CODE" type="text" readonly  maxlength="50" tabindex="0" >    </input>

        	<div  class="infoLabel" style=" position: absolute; top:107px; left:54px;  width:131px; height:19px; " id="label3" name="label3"><label style=" line-height:21px; " >    Error Description     </label>    </div>

        	<textarea  style=" position: absolute; top:107px; left:190px;  width:229px; height:50px; background-color:#EBF7FF;border: 1px solid #a0c3f5 ;" id="S_ERROR_MSG" name="S_ERROR_MSG" tabindex="0"  readonly="readonly"  ></textarea>
