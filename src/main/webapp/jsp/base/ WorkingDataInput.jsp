...
<div id="divPopup_ErrorCode" name="divPopup_ErrorCode" style="display:none;background-color:white;">
	<iframe id="Error_cd" name="Error_cd" style="width:500px;height:190px;" scrolling="auto">
        	...
        	<input  class="TextBox-S" style=" position: absolute; top:110px; left:387px;  width:97px; height:17px; " id="S9_LOG_SEQ" name="S9_LOG_SEQ" type="text" maxlength="50" tabindex="0" >    </input>
...
<script type="text/javascript" >
    ...
    var sbmUpload = new SubMission( frm, "/hpms/20160912111169WorkDataInput_workCountUpload.do","S1[A]:S1","S9:SEL87","");
