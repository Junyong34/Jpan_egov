...
public class CostInUpload
{
    ...
    public   DOBJ uploadCostExcel( DOBJ _indobj )
    {
        ...
        try
        {
            ...
            //System.out.println("Cost:FileInfo:" + fullname +":" );
        ...
        System.out.println("COST:RETURN:" + _indobj.getRtncode() +":" + _indobj.getRetmsg());
        return _indobj;
    }
    private boolean isSetDefault(String colnm, Object value)
    {
        if(colnm.toUpperCase().equals("APPLICATION")
    ...
    private boolean isNumber(String value)
    {
        try
        {
        	...
        	/*String MM = value.substring(4);
        	if(MM != "01" || MM != "02" || MM != "03" || MM != "04" || MM != "05" || MM != "06" || MM != "07" || MM != "08"
